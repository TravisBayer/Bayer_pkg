...
```{r eval=FALSE, include=TRUE}
download.file(url ="https://raw.githubusercontent.com/TravisBayer/Bayer_pkg/master/data/ACC.csv", destfile = "/cloud/project/homeworks/ACC.csv")

download.file(url ="https://raw.githubusercontent.com/TravisBayer/Bayer_pkg/master/data/BatGPS.csv", destfile = "/cloud/project/homeworks/BatGPS.csv")

download.file(url ="https://raw.githubusercontent.com/TravisBayer/Bayer_pkg/master/data/uro_data_r.csv", destfile = "/cloud/project/homeworks/uro_data_r.csv")

#Download and read each of the necessary data sets from Google Sheets
```

```
#Next assign each data set to the appropriate object titles

accdata <- read_csv("/Cloud/project/data/ACC.csv")

batcoord <- read_csv("/Cloud/project/data/BatGPS.csv")

BatData <- read_csv("/Cloud/project/data/uro_data_r.csv")
```


```
#Finally, once required packages and data has been acquired we can install our package

install.packages("Bayer.project")
...
![Heart Rate Histogram](/Cloud/project/graphics/Rplot.pdf)
...
![PowerCurve](/Cloud/project/graphics/powerplot.pdf)
